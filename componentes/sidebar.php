...
<div id="sidebar" class="sidebar">
    <div class="sidebar-menu">
        ...
        <a href="/ensinoestruturadedados/explicacao/FilaFIFO/Exemplo.php" class="sidebar-item">Fila FIFO</a>
        <a href="/ensinoestruturadedados/explicacao/FilaFIFO/Exemplo.php" class="sidebar-subitem">Operações</a>
    </div>
</div>
