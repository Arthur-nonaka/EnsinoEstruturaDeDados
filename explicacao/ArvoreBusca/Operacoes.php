...
<body>
        ...
        <p class="has-text-justified">
            <li>Procura um valor específico na Árvore Binária de Busca:</li>
        ...
        <p class="has-text-justified">
            <li>Adiciona um novo valor à Árvore Binária de Busca:</li>
            <section class="mt-2 is-flex is-justify-content-center">
                <pre style="min-width: 50vw; height: 30vh;">
        <span>class BinarySearchTree</span>
        <span>{</span>
        ...
        <p class="has-text-justified">
            <li>Remove um valor da Árvore Binária de Busca:</li>
            <section class="mt-2 is-flex is-justify-content-center">
                <pre style="min-width: 50vw; height: 30vh;">
        <span>class BinarySearchTree</span>
        <span>{</span>
        ...
        <p class="has-text-justified">
            <li>Percorre os valores da Árvore Binária de Busca em ordem crescente:</li>
            <section class="mt-2 is-flex is-justify-content-center">
                <pre style="min-width: 50vw; height: 30vh;">
        <span>class BinarySearchTree</span>
        <span>{</span>
